...
def add_all_arguments(parser, train, train_encoder):
    ...
    if train:
        ...
        parser.add_argument('--freq_fid', type=int, default=1000000, help='frequency of saving the fid score (in training iterations)')
        ...
        parser.add_argument('--num_epochs', type=int, default=100000, help='number of epochs to train')
